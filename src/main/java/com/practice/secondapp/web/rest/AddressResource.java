...
import com.practice.secondapp.service.AddressQueryService;
import com.practice.secondapp.service.AddressService;
...
/**
 * REST controller for managing {@link com.practice.secondapp.domain.Address}.
 */
@RestController
@RequestMapping("/api")
