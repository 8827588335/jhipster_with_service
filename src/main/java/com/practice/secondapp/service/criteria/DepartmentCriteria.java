...
/**
 * Criteria class for the {@link com.practice.secondapp.domain.Department} entity. This class is used
 * in {@link com.practice.secondapp.web.rest.DepartmentResource} to receive all the possible filtering options from
...
public class DepartmentCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, departmentName, employeeId, distinct);
    }
