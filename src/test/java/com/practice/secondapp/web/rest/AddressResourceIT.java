...
class AddressResourceIT {
    ...
    void getAllAddressesByStreetAddressIsEqualToSomething() throws Exception {
        ...
        // Get all the addressList where streetAddress equals to DEFAULT_STREET_ADDRESS
        defaultAddressShouldBeFound("streetAddress.equals=" + DEFAULT_STREET_ADDRESS);

        // Get all the addressList where streetAddress equals to UPDATED_STREET_ADDRESS
        defaultAddressShouldNotBeFound("streetAddress.equals=" + UPDATED_STREET_ADDRESS);
    }
    ...
    void getAllAddressesByStreetAddressIsInShouldWork() throws Exception {
        ...
        // Get all the addressList where streetAddress in DEFAULT_STREET_ADDRESS or UPDATED_STREET_ADDRESS
        defaultAddressShouldBeFound("streetAddress.in=" + DEFAULT_STREET_ADDRESS + "," + UPDATED_STREET_ADDRESS);

        // Get all the addressList where streetAddress equals to UPDATED_STREET_ADDRESS
        defaultAddressShouldNotBeFound("streetAddress.in=" + UPDATED_STREET_ADDRESS);
    }
    ...
    void getAllAddressesByStreetAddressIsNullOrNotNull() throws Exception {
        ...
        defaultAddressShouldBeFound("streetAddress.specified=true");

        // Get all the addressList where streetAddress is null
        defaultAddressShouldNotBeFound("streetAddress.specified=false");
    }
    ...
    void getAllAddressesByStreetAddressContainsSomething() throws Exception {
        ...
        // Get all the addressList where streetAddress contains DEFAULT_STREET_ADDRESS
        defaultAddressShouldBeFound("streetAddress.contains=" + DEFAULT_STREET_ADDRESS);

        // Get all the addressList where streetAddress contains UPDATED_STREET_ADDRESS
        defaultAddressShouldNotBeFound("streetAddress.contains=" + UPDATED_STREET_ADDRESS);
    }
    ...
    void getAllAddressesByStreetAddressNotContainsSomething() throws Exception {
        ...
        // Get all the addressList where streetAddress does not contain DEFAULT_STREET_ADDRESS
        defaultAddressShouldNotBeFound("streetAddress.doesNotContain=" + DEFAULT_STREET_ADDRESS);

        // Get all the addressList where streetAddress does not contain UPDATED_STREET_ADDRESS
        defaultAddressShouldBeFound("streetAddress.doesNotContain=" + UPDATED_STREET_ADDRESS);
    }
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.postalCode(UPDATED_POSTAL_CODE).city(UPDATED_CITY);
